/* Moment.js | version : 1.1.0 | author : Tim Wood | license : MIT */
...
// 防抖函数
function fswpDebounce(func, delay) {
  let timeoutId;
...
function fswpCreateSearchInterface(parentElement = document.body) {
  ...
  const debouncedSearch = fswpDebounce(function() {
    fswpJumpToMatchedTextNode.call(this, parentElement);
  }, 300);

  // 保存防抖函数引用
  input._fswpDebouncedSearch = debouncedSearch;
